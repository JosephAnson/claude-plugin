...
description: DDD component architecture for Vue/Nuxt projects — folder structure, naming conventions, translation keys, and component organisation. Use when creating components, choosing file paths, naming files, structuring translations, or organising domain folders.
---
